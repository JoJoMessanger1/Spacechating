...
function initializePeer() {
    const YOUR_RENDER_HOST = 'https://spacechating-1.onrender.com'; 

    if (YOUR_RENDER_HOST.includes('DEINE_RENDER')) {
        console.warn("ACHTUNG: Es wird der öffentliche PeerJS Server verwendet. Füge deine Render-Adresse in initializePeer() ein!");
        peer = new Peer(myID);
    } else {
        peer = new Peer(myID, {
